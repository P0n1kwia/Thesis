...
Przykładowy wynik działania zaimplementowanego potoku renderowania przedstawiono na rysunku~\ref{rys:przykladowy_render}.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{bicycle}
  \caption{Przykładowy obraz sceny 3DGS wygenerowany przez
  zaimplementowany renderer.}
  \label{rys:przykladowy_render}
\end{figure}
...
Pełny widok interfejsu aplikacji przedstawiono na
rysunku~\ref{rys:interfejs_aplikacji}.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{Ui}
  \caption{Interfejs aplikacji z panelami sterowania renderowaniem,
  statystykami wydajności i narzędziami diagnostycznymi.}
  \label{rys:interfejs_aplikacji}
\end{figure}
